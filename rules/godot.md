...
Before writing or reviewing a `*_test.gd` file, load the `writing-gdunit4-tests` skill.
...
| Writing tests                                           | `writing-gdunit4-tests` skill                |
| Running tests                                           | `gdunit4_run` tool (`running-gdunit4-tests`) |
